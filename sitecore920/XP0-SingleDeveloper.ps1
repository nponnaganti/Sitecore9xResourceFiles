...
$Prefix = "scsxa920"
# The Password for the Sitecore Admin User. This will be regenerated if left on the default. SIF-Default
...
$SolrRoot = "E:\solr-7.5.0"
# The Name of the Solr Service. Solr-7.5.0 solr750
