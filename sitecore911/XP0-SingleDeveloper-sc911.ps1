#"Site.PhysicalPath": "[joinpath(parameter('InstallDirectory'), parameter('SiteName'))]", update in IdentityServer.json, sitecore-XP0.json and xconnect-xp0.json
$InstallDirectory = "E:\projects\ames\dep"
# The Prefix that will be used on SOLR, Website and Database instances.
$Prefix = "sc911"
# The Password for the Sitecore Admin User. This will be regenerated if left on the default.
$SitecoreAdminPassword = "b"
# The root folder with the license file and WDP files.
$SCInstallRoot = "E:\ResourceFiles\sitecore911"
